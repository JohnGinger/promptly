  ...
  return (
    <>
      ...
      <div className=" text-xl font-bold font-sans mt-4">
        9 hints to prompt engineering
      </div>
      <ol className="space-y-1  list-decimal list-inside dark:text-gray-400 mb-4">
        <li>
        ...
        <li>
          Be clear and direct
          <div className="text-gray-500">
            Show your prompt to a friend and ask them to follow the instructions
            themselves to see whether they produce the exact result you’re
            looking for
          </div>
        </li>
        <li>
        ...
        <li>
          ...
          <div className="text-gray-500">
            Start the end of your prompt with the beginning of the response you
            want to generate.
          </div>
        </li>
        <li>
        ...
        <li>
          Use examples{' '}
          <div className="text-gray-500">
            Examples are probably the single most effective tool for getting the
            AI to behave as desired
          </div>
        </li>
        <li>
          Let the AI say it doesn&rsquo;t know
          <div className="text-gray-500">
            Give the AI permission to say it doesn&rsquo;t know the answer to a
            question, so it won&rsquo;t make up an answer
          </div>
        </li>
      </ol>
    </>
